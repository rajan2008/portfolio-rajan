...
using use = useUsing("use")`,
  ...
  [SkillNames.PHOTOSHOP]: {
    ...
    shortDescription: "Turning pixels into pure magic, fr fr! 🎨✨",
    color: "#31A8FF",
  ...
  [SkillNames.ILLUSTRATOR]: {
    ...
    shortDescription: "Vector vibes are immaculate, no cap! 📐🔥",
    color: "#FF9A00",
  ...
  [SkillNames.FIGMA]: {
    ...
    name: "figma",
    label: "Figma",
    shortDescription: "UI/UX drip hitting different, respectfully! 💻🎨",
    color: "#F24E1E",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg",
  },
  [SkillNames.SKETCHING]: {
    id: 29,
    name: "sketching",
    label: "Hand Sketching",
    shortDescription: "Raw creativity with just a pencil, the OG flex! ✏️🎨",
    color: "#999",
    icon: "https://www.svgrepo.com/show/422281/paint-brush-writing.svg",
  },
};
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Drove organizational growth through strategic business development initiatives.",
      "Engaged in network expansion and market positioning strategies.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.HTML,
  ...
  },
  {
    ...
    company: "Union Enterprise (Custora)",
    description: [
      "Participated in rapid live project assignments and agile design sprints.",
      "Collaborated closely with team leads, producing high-quality deliverables.",
    ],
    skills: [
      SkillNames.HTML,
      SkillNames.CSS,
  ...
  },
  {
    ...
    description: [
      "Successfully executed foundation-level digital design tasks focused on brand identity.",
      "Recognized for a highly result-oriented and hard-working approach.",
    ],
    skills: [
      SkillNames.PHOTOSHOP,
      SkillNames.ILLUSTRATOR,
